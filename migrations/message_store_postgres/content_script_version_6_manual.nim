## Manual script for migration 5 -> 6
## This script was created for situation where the total disk size can't be doubled.

const ContentScriptVersion_6_1 =
"""
-- Rename old table
