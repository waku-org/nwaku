...
proc toWakuMessage*(relayMessage: WakuRelayMessage, version: uint32, rng: ref keys.HmacDrbgContext, symkey: Option[SymKey], pubKey: Option[keys.PublicKey]): WakuMessage =
