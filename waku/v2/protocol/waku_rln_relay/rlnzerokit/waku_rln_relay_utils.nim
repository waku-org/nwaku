...
import
  ...
  ../../../node/[wakunode2_types,config],  #TODO: remove the extra ../ once zerokit is fully merged
  ../../waku_message                       #TODO: remove the extra ../ once zerokit is fully merged

  

logScope:
  topics = "wakurlnzerokitrelayutils"
...
proc validateMessage*(rlnPeer: WakuRLNRelay, msg: WakuMessage,
  ...
  if not proofVerify(rlnPeer.rlnInstance, input, msg.proof):
    # invalid proof
