...
suite "Postgres driver store v2":
  ...
  asyncTest "Asynchronous queries store v2":
  ...
  asyncTest "Insert a message store v2":
  ...
  asyncTest "Insert and query message store v2":
  ...
  asyncTest "Insert true duplicated messages store v2":
