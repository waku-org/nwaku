...
import
  ...
  ../../waku/v2/protocol/waku_rln_relay/rlnzerokit/[waku_rln_relay_utils,   
      waku_rln_relay_types, rln_relay_contract],                            ##TODO: remove rlnzerokit ref once zerokit rln is merged
...
procSuite "Waku-rln-relay (zerokit)":
