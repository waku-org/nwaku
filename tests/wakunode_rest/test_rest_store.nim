...
procSuite "Waku Rest API - Store v3":
  ...
  asyncTest "correct message fields are returned":
    ...
    check:
      storeMessage.message.payload == msg.payload
      storeMessage.message.contentTopic == msg.contentTopic
      storeMessage.message.version == msg.version
      storeMessage.message.timestamp == msg.timestamp
      storeMessage.message.ephemeral == msg.ephemeral
      storeMessage.message.meta == msg.meta
