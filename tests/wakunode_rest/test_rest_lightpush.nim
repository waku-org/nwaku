...
import
  waku/[
    ...
    waku_rest/endpoint/lightpush/types,
    waku_rest/endpoint/lightpush/handlers as lightpush_rest_interface,
    waku_rest/endpoint/lightpush/client as lightpush_rest_client,
    waku_relay,
