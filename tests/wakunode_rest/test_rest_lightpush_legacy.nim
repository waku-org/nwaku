...
import
  waku/[
    ...
    waku_rest/endpoint/legacy_lightpush/types,
    waku_rest/endpoint/legacy_lightpush/handlers as lightpush_rest_interface,
    waku_rest/endpoint/legacy_lightpush/client as lightpush_rest_client,
    waku_relay,
